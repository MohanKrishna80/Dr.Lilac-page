...
export default function Footer() {
  return (
    <footer className="bg-neutral-50 px-4 md:px-12 pt-14 md:pt-20">
      ...
      {/* Top Section */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start text-sm md:text-base text-gray-700 pb-14 md:pb-20">
        ...
        {/* Hours + Find */}
        <div className="flex flex-row md:flex-row justify-between w-full md:w-auto gap-10 md:gap-24 mt-10 md:mt-0">
